...
int main(){
	...
	ListIterator *it_2 = listIterator_create(l, 1);
    printf("%d\n", listIterator_value(it_2));
	
	for(it = listIterator_begin(it_2); !listIterator_end(it_2); it = listIterator_next(it_2))  printf("%d\n", listIterator_value(it_2));
